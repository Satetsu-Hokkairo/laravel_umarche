                        ...
                        <div class="container px-5 mx-auto">
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <tr>
                                    ...
                                    @csrf
                                        <td class="px-4 py-3">
                                        <a href="#" data-id="{{ $owner->id}}" onclick="deletePost(this)" class="text-white bg-red-400 border-0 py-2 px-8 focus:outline-none hover:bg-red-500 rounded">完全に削除</button>
                                        </td>
                                    </form>
                                </tr>
                                @endforeach
