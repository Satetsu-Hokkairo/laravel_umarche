            ...
            <div class="lg:flex lg:justify-around">
                <div class="lg:flex items-center">
                    ...
                    <div class="flex space-x-2 items-center">
                        ...
                        <div><button class="flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">検索する</button></div>
                    </div>
                </div>
                <div class="flex">
                    <div>
                        <span class="test-sm">表示順</span><br>
